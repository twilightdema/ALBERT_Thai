...
python3 run_squad_v1.py \
  ...
  --train_feature_file=${SQUAD_DATA_DIR}/train-v1.1.tfrecord \
  --predict_feature_file=${SQUAD_DATA_DIR}/dev-v1.1.tfrecord \
  --predict_feature_left_file=${SQUAD_DATA_DIR}/dev-v1.1.left.tfrecord \
